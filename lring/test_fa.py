...
rank = 0
model = AutoModelForCausalLM.from_pretrained("/home/test/test01/zwl/models/Meta-Llama-3-8B", attn_implementation='eager', torch_dtype=torch.float32, device_map=torch.device(f"cuda:{rank}"))
tokenizer = AutoTokenizer.from_pretrained("/home/test/test01/zwl/models/Meta-Llama-3-8B")
