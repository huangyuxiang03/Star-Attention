...
model = AutoModelForCausalLM.from_pretrained("/home/test/test01/hyx/Llama-3.2-1B-instruct", device_map="cuda", torch_dtype=torch.float16, attn_implementation="flash_attention_2")
tokenizer = AutoTokenizer.from_pretrained("/home/test/test01/hyx/Llama-3.2-1B-instruct")
